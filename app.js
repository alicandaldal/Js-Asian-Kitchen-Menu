...
let menuSection = document.querySelector(".btn-container");
...
function eventListeners(){
    window.addEventListener("load", buttonOperation);
...
function buttonOperation() {
  ...
  menuSection.innerHTML = createButton("All")  + createButton("Korea")  + createButton("Japan") + createButton("China");
...
function addFoodsAll() {
  ...
  menu.forEach(element => {
    mainSection.innerHTML += (" " + foodCreator(element))
  });
}
